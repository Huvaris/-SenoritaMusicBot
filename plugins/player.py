...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                InlineKeyboardButton('⚡️Make Own Bot', url='https://github.com/Sumit9969/-SenoritaMusicBot'),
                InlineKeyboardButton('🧩 Join Here', url='https://t.me/Friends_Masti_Group'),
            ]
            ]
        await m.reply("<b>You can't use this bot in this group, for that you have to make your own bot from the [SOURCE CODE](https://github.com/Sumit9969/-SenoritaMusicBot) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
